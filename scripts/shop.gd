...
func _create_tower_options() -> void:
	...
	for tower in tower_data.tower_data_list:
		...
		shop_item.is_valid = func():
			return building_game.has_started and building_game.money >= shop_item.display_cost
...
func _create_unit_options() -> void:
	...
	for unit in unit_data.unit_data_list:
		...
		shop_item.is_valid = func():
			return (
				building_game.has_started
				and building_game.money >= shop_item.display_cost
