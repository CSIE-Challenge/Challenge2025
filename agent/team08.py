...
#連接登入種子
agent = GameClient(7749, "10004ff0")
...
def play():
    ...
    global ground_tower_upgrade
    global air_tower_upgrade
    g_i = 0
    a_i = 0
    l_i = 0
    place_ground_next = 0
    ...
    while g_i < len(ground_scores) or a_i < len(air_scores) or l_i < len(luigi_score):
        ...
        if place_ground_next == 0 and g_i < len(ground_scores):
            ...
            if pos in used_positions:
                ...
                agent.place_tower(ground_tower_type, ground_tower_upgrade, Vector2(pos[0], pos[1]))
